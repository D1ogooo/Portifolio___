import {
  Container, LeftContentFirst, RightContentFirst, InternalLeft, Seta1,
  RightSecond, LeftSecond, FirstChild, SecondChild, SecondContainer, Abc
} from './style';
import {
  Main, MainFirst, MainSecond, Links
} from './style';
            ...
            <MainSecond>
              ...
              <LeftSecond>
                ...
                <SecondChild id='sobremin'>
                  <p>Sobre mim</p>
                  <h2>
                    Sou um Desenvolvedor apaixonado pela programação e estou em busca da minha primeira vaga
                  </h2>
                  <h3>
                    Desde criança, sempre gostei de criar coisas. Sou apaixonado por T.I e muito voltado para programação web,
                    amo bastante a música e tocar bateria. Tenho uma paixão por teclado e nos tempos vagos, crio projetos e estudo
                    para evoluir na área. Sou uma pessoa bastante observadora e acabo tendo ideias de projetos até com coisas do dia a dia.
                    Pode-se dizer que sou bastante criativo.
                  </h3>
                </SecondChild>
                <Abc>
                 <MeuResumo />
