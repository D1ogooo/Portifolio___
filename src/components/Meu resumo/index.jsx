  ...
  <AlertDialog.Root>
    ...
    <AlertDialog.Portal>
      ...
      <AlertDialog.Content className="AlertDialogContent">
        ...
        Olá, meu nome é Diogo e sou Desenvolvedor Fullstack. Des de menor de idade, sempre fui apaixonado por criar coisas,
         mas não sabia nada sobre esse mundo da programação. Porém, em 2018 descobri a existência dele através de um amigo,
          Comecei meus estudos na programação no ano de 2022, e fui estudando o frontend des de a base até o framework, venho
